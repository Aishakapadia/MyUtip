...
@section('content')
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
                                            ...
                                            <div class="portlet blue-hoki box">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="portlet-body form">
                                                        ...
                                                        {!! Form::model($ticket, ['method' => 'PUT', 'route' => ['ticket-status.ticket', $ticket->id], 'class' => 'form-horizontal form-bordered','files'=> true]) !!}
            ...
            <div class="row"><!--Uploaded Files START-->
                <div class="col-md-12 col-sm-12">
                    <div class="portlet blue-hoki box">
                        <div class="portlet-title">
                            <div class="caption">
                            ...
                            <div class="table-scrollable table-scrollable-borderless">
                                <table class="table table-hover">
                                    ...
                                    @if(count($files))
                                        @foreach($files as $f)
                                            <tr >
                                                <td> <a href="\uploads\files\{{ $f->file }}" target="_blank" download>{{ $f->file }}</a></td>
                                                <td>{{ date(\App\Setting::getStandardDateTimeFormat(), strtotime($f->created_at)) }}</td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr >
